...
export class CreateChronologyDto {
  @ApiProperty({
    type: TranslationDto,
    description: 'Trilingual milestone label (e.g. "May 2024")',
  })
  @ValidateNested()
  @Type(() => TranslationDto)
  ...
  @ApiPropertyOptional({ type: TranslationDto, description: 'Trilingual milestone body/summary' })
  @IsOptional()
  @ValidateNested()
  @Type(() => TranslationDto)
  description?: TranslationDto;

  @ApiPropertyOptional({ example: '2024-05-03T00:00:00.000Z', description: 'Milestone date' })
